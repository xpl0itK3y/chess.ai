    ...
    try {
      ...
      response = await openaiClient.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "Ты - гроссмейстер с рейтингом 2800+. Анализируй позицию на глубину 5-6 ходов вперед. Оценивай позицию по материалу, активности фигур, безопасности короля, структурным преимуществам. Отвечай только одним лучшим ходом в алгебраической нотации."
          },
          {
            role: "user",
            content: prompt
        ...
        max_tokens: 15,
        temperature: 0.3, // Меньше случайности, больше точности
      });
